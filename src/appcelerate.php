...
class APPcelerate {
	...
	public function getInclude($type, $params) {
		...
		<link href="'.$b.'/vendor/flodi/appcelerate/src/include/css/tabulator_bootstrap4.min.css" rel="stylesheet">
					...
					if ($this->app["bootstrap"]==5) {
						$c.='
		<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.bundle.min.css" rel="stylesheet" integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
